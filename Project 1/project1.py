...
# * The game is played for a predetermined number of rounds, and the player with the most wins at the end of the game is declared the overall winner.
...
# yousef jamel
# ! The game is a simple implementation of the classic game Rock, Paper, Scissors.
